...
function addSearchFunctionality() {
    ...
    searchContainer.innerHTML = `
        <div class="search-box">
            ...
            <input type="text" id="searchInput" placeholder="Search privacy policy...">
    ...
    // Insert search after privacy header
    const privacyHeader = document.querySelector('.privacy-header');
    if (privacyHeader) {
        privacyHeader.parentNode.insertBefore(searchContainer, privacyHeader.nextSibling);
    }
